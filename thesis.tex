...
% タイトル
\def\title{地理的に分散したシステムのためのステージング環境の設計と構築}
% 英語タイトル
\def\etitle{Designing and Implementation the staging environment for geographically distributed system}
% 著者(日本語)
\def\author{廣川昂紀}
% 著者(英語)
